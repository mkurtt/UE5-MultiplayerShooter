...
UCLASS(ClassGroup=(Custom), meta=(BlueprintSpawnableCom143ponent))
...
protected:
	...
	FFramePackage InterpBetweenFrames(const FFramePackage& OlderFrame, const FFramePackage& YoungerTime, float HitTime);
